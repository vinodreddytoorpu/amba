...
vsim -c -do "run -all; quit" work.top +UVM_TESTNAME=amba_apb5_requester_write_read_test *> simulate.log

# Run simulation with GUI
# vsim work.top +UVM_TESTNAME=amba_apb5_requester_write_read_test
